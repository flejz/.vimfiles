...
_WebResourceData_WebResourceMIMEType_WebResourceTextEncodingName^WebResourceURL_WebResourceFrameNameOBÖ<html><head></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">" Maintainer: Alexander Imenes &lt;alexander.imenes@gmail.com&gt;
...
augroup END
</pre></body></html>Ztext/plainUUTF-8_]https://raw.githubusercontent.com/Reewr/vim-monokai-phoenix/master/colors/monokai-phoenix.vimP    ( : P n } ”CnCyCCß                           Cà